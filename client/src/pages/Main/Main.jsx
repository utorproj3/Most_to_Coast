    ...
    <div className="main">
      ...
      <form className="search-form">
        <div className="search-wrap">
          <label className="search-input-text">Explore Plans</label>
          <br></br>
          <input
          ...
          <button
            ...
            onClick={() => getPlans({ variables: { username: findUser } })}
          >
            search
          </button>
        </div>
      ...
      <div className="container-fluid">
        <div className="text-center">
          {allTravelPlansData
            ? allTravelPlansData.map((allUserData) => {
                return (
        ...
        <div className="text-center">
          {userData
            ? userData.searchPlansByUser.myPlans.map((plans) => {
                return (
                  <div className="text-left">
